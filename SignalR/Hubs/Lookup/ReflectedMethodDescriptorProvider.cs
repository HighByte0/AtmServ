...
namespace SignalR.Hubs
{
    public class ReflectedMethodDescriptorProvider : IMethodDescriptorProvider
    {
        ...
        private static string BuildHubExecutableMethodCacheKey(HubDescriptor hub, string method, JToken[] parameters)
        {
        ...
        bool IMethodDescriptorProvider.TryGetMethod(HubDescriptor hub, string method, out MethodDescriptor descriptor, params JToken[] parameters)
        {
